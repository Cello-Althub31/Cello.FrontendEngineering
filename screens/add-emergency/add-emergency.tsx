                ...
                >
                    ...
                    <View style={modalStyles.whatsNextBox}>
                        ...
                        <Text style={modalStyles.whatsNextText}>
                            <Text style={modalStyles.boldText}>{contactName}</Text> will receive a
                            message explaining that you'd like to add them as an emergency
                            contact.
                        </Text>
                        <Text style={modalStyles.whatsNextText}>
...
const AddNewContact = () => {
    ...
    const handleNext = () => {
        ...
        console.log('New Contact Data:', { fullName, phoneNumber, emailAddress, relationship });
                    ...
                    <View style={styles.inner}>
                        ...
                        <View style={styles.formContainer}>
                            ...
                            <TouchableOpacity
                                ...
                                activeOpacity={0.7}
                            >
                                <Feather name="heart" size={20} color="#777" style={styles.inputIcon} />
                                <Text style={relationship ? styles.dropdownText : styles.dropdownPlaceholder}>
